...
väärtused = (2, 3, 4, 5, 6, 7, 8, 9, 10, 10, 10, 10, 11) * 4  # 4 erinevat masti, 10, J, Q, K sama väärtusega, A on 11
KaardiVäärtus = {kaart: väärtus for kaart, väärtus in zip(kaardid, väärtused)}

# ----------------
# Ma pole kindel, kui suur osa programmist peaks olema funktsioonides, võid vabalt võtta funktsioonist välja kui soovid
...
def hit():
    global kaardipakk
    global KaardiHulk
    sega() if KaardiHulk == 0 else None
    KaardiHulk -= 1
